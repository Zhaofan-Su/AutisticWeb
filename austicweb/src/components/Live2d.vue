<template>
  <div id="landlord">
    ...
    <canvas id="live2d" width="280" height="250" @mouseover="prompt"></canvas>
  </div>
</template>

<script>
import '../../static/live2d/live2d'
import * as animate from '../../static/live2d/animate'
import '../../static/live2d/message'
...
export default {
  ...
  created () {
    ...
    setTimeout(function () {
      loadlive2d('live2d', "../static/live2dw/live2d-widget-model-hijiki/assets/hijiki.model.json")
    })
